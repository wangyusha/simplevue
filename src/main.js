...
import {Button, Row, Col,Icon ,Swipe, SwipeItem,Lazyload,List,NavBar,
  ...
  Cell, CellGroup,Sku,Search,Tag,ImagePreview,AddressList,Popup,Card,RadioGroup, Radio,
  Uploader} from 'vant';
import './uitil/rem.js';
...
Vue.use(Button).use(Row).use(Col).use(Icon).use(AddressEdit)
  ...
  .use(AddressList).use(Popup).use(Card).use(RadioGroup).use(Radio).use(Uploader);
